...
``` cmd
docker tag sheyenrath/wiremock.net-nanoserver-1809:latest sheyenrath/wiremock.net-nanoserver-1809:1.24.0
```
...
docker push sheyenrath/wiremock.net-nanoserver-1809:1.24.0
```