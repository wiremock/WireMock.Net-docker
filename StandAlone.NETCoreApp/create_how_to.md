...
``` cmd
docker tag sheyenrath/wiremock.net-nanoserver-1809:latest sheyenrath/wiremock.net-nanoserver-1809:2.2.0
```
...
docker push sheyenrath/wiremock.net-nanoserver-1809:2.2.0
```